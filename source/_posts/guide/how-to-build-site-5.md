...
![新建终端](https://raw.gitmirror.com/828767/static/master/images/vscode_new_terminal.png)

该终端默认使用系统终端，功能上有些许差异，建议设置默认终端为 `Git Bash`，方法：点击终端窗口右上角 ➕ 右侧的 `下拉箭头`

![设置默认终端](https://raw.gitmirror.com/828767/static/master/images/vscode-set-terminal-defalt.png)
![选择Git Bash](https://raw.gitmirror.com/828767/static/master/images/vscode-set-terminal-git.png)
...
![打开文件夹](https://raw.gitmirror.com/828767/static/master/images/vscode_markdown_editor.png)
...
![Git操作界面概览](https://raw.gitmirror.com/828767/static/master/images/vscode-git.png)
...
![Git同步状态](https://raw.gitmirror.com/828767/static/master/images/github-sync.png)

> 上图中 `🔄 0↓ 1↑` 表示有 0 个变更待拉取/下载，有 1 个变更待推送/上传

如果想一次性完成提交和推送，可以在填写完变更信息后，点击提交右侧的下拉按钮选择提交并推送。

![Git提交并推送](https://raw.gitmirror.com/828767/static/master/images/vscode-git-push.png)

VSCODE 界面上其他按钮功能可以将鼠标移动到对应图形上方悬停一下，然后就会有功能提示了，请自行查阅并使用。基本的演示如动图：

![简单的Git提交演示](https://raw.gitmirror.com/828767/static/master/images/vscode-git-commit.gif)
